import { Box, Text, Input, FormControl, FormLabel, Button, Divider, Select, Flex } from '@chakra-ui/react';
        ...
        <Box position={'relative'} >
            <form onSubmit={handleSubmit}>
                <FormControl >
                    ...
                    <Flex mb='20px'>
                        <Button variant='outline' onClick={(e) => setPlatform('instagram')} bg={platform === 'instagram' ? 'cyan.400' : 'white'} _hover={{ bg: '#7dc5ea' }}>
                            <Instagram width='20px' height='20px' />
                            <Text color={platform === 'instagram' ? 'white' : 'gray.700'}>Instagram</Text>
                        </Button>
                        <Button variant='outline' onClick={(e) => setPlatform('facebook')} bg={platform === 'facebook' ? 'cyan.400' : 'white'} _hover={{ bg: '#7dc5ea' }}>
                            <Facebook width='20px' height='20px' />
                            <Text color={platform === 'facebook' ? 'white' : 'gray.700'}>Facebook</Text>
                        </Button>
                        <Button variant='outline' onClick={(e) => setPlatform('twitter')} bg={platform === 'twitter' ? 'cyan.400' : 'white'} _hover={{ bg: '#7dc5ea' }}>
                            <Twitter width='20px' height='20px' />
                            <Text color={platform === 'twitter' ? 'white' : 'gray.700'}>Twitter</Text>
                        </Button>
                        <Button variant='outline' onClick={(e) => setPlatform('linkedin')} bg={platform === 'linkedin' ? 'cyan.400' : 'white'} _hover={{ bg: '#7dc5ea' }}>
                            <Linkedin width='20px' height='20px' />
                            <Text color={platform === 'linkedin' ? 'white' : 'gray.700'}>Linkedin</Text>
                        </Button>
                        ...
                        <Box>
                            <Input type='text' name="platform" onChange={(e) => setPlatform(e.target.value)} placeholder='その他'></Input>
                        </Box>
                    </Flex>
                    <FormLabel>③{t("sns.newSns.about")}</FormLabel>
                    <Input mb='20px' type='text' name="description" value={postDescription}
                    ...
                    {isGenerating ? <Button mt='20px' isLoading loadingText={t("generating") as string} /> : <Button mt='20px' colorScheme='blue' bg='cyan.400' _hover={{ bg: "#7dc5ea" }} variant='solid' type="submit" >{t("sns.newSns.button")}</Button>}
                </FormControl>
            </form>
