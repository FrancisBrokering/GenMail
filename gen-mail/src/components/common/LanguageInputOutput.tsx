import { Box, Text, FormLabel, Divider, Button, Flex, Select, Center } from '@chakra-ui/react';
...
const LanguageInputOutput = (props: LanguageInputOutputProps) => {
    ...
    return (
        <Box mb='20px'>
            <Text textAlign='center' mb='50px' fontWeight="bold" fontSize='20px' >{props.pageTitle}</Text>
